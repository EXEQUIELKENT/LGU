...
-- Optional engineer on CPRF-linked schedules (assigned_team may be used instead)
ALTER TABLE maintenance_schedule
    MODIFY COLUMN engineer_id INT UNSIGNED NULL DEFAULT NULL;

ALTER TABLE maintenance_schedule
    MODIFY COLUMN estimated_completion_date DATETIME NULL DEFAULT NULL;
