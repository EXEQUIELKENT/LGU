...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    if ($cooldownActive) {
        ...
        header("Location: " . cimm_url('profile.php'));
        exit;
    }
...
<div class="sidebar-nav" id="sidebarNav">
    ...
    <div class="sidebar-top">
        ...
        <ul class="nav-list">
            ...
            <li>
                <a href="<?= cimm_url_attr('profile.php') ?>" class="nav-link<?= $isProfilePage ? ' active' : '' ?>" data-tooltip="Profile"><i class="fas fa-user"></i><span>Profile</span></a>
            </li>
            <?php endif; ?>
        </ul>
