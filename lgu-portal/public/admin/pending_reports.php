...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'delete_daily_image') {
        ...
        // Client-side rendering prefixes stored paths with "../" (admin pages
        // live one folder below public/); strip it back off before using the
        // path for the DB match or the filesystem delete below.
        if (strpos($imgPath, '../') === 0) {
...
/* View button — soft outline style (matches case_management.php's
   ...
   at rest, solid fill on hover. Pending Reports keeps its dark-orange accent. */
.btn-view-rep {
...
[data-theme="dark"] .btn-view-rep { background:rgba(255,109,0,.14); color:#ffab5e; border-color:rgba(255,109,0,.4); }
...
<?php endif; ?>
    ...
    <div class="he-no-district-banner">
        ...
        <div>
            ...
            <span>Set your district in your <a href="<?= cimm_url_attr('profile.php') ?>#aeDistrictSection">profile</a> to view and manage pending reports in your area.</span>
        </div>
    </div>
    <?php endif; ?>
