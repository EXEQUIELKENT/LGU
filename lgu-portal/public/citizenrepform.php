...
<body>
    ...
    const QC_BARANGAYS_COMPREHENSIVE = [
        // DISTRICT 1 (37 barangays — western/central QC)
        ...
        { name: "Camp Aguinaldo", lat: 14.6280, lng: 121.0580, district: "District 3" },
        ...
        { name: "East Kamias", lat: 14.6289, lng: 121.0512, district: "District 3" },
        ...
        { name: "Loyola Heights", lat: 14.6398, lng: 121.0775, district: "District 3" },
        ...
        { name: "Matandang Balara", lat: 14.6978, lng: 121.0734, district: "District 3" },
        { name: "Milagrosa", lat: 14.6901, lng: 121.0545, district: "District 3" },
        { name: "Pansol", lat: 14.6523, lng: 121.0823, district: "District 3" },
        { name: "Quirino 2-A", lat: 14.6223, lng: 121.0478, district: "District 3" },
        { name: "Quirino 2-B", lat: 14.6245, lng: 121.0501, district: "District 3" },
        { name: "Quirino 2-C", lat: 14.6267, lng: 121.0523, district: "District 3" },
        { name: "Quirino 3-A", lat: 14.6289, lng: 121.0534, district: "District 3" },
        { name: "San Roque", lat: 14.6312, lng: 121.0545, district: "District 3" },
        { name: "Silangan", lat: 14.6334, lng: 121.0556, district: "District 3" },
        { name: "Socorro", lat: 14.6289, lng: 121.0534, district: "District 3" },
        { name: "St. Ignatius", lat: 14.6934, lng: 121.0634, district: "District 3" },
        { name: "Tagumpay", lat: 14.6923, lng: 121.0523, district: "District 3" },
        { name: "Ugong Norte", lat: 14.6612, lng: 121.0534, district: "District 3" },
        { name: "Villa Maria Clara", lat: 14.6945, lng: 121.0545, district: "District 3" },
        { name: "West Kamias", lat: 14.6256, lng: 121.0467, district: "District 3" },
        { name: "White Plains", lat: 14.6267, lng: 121.0589, district: "District 3" },
        // DISTRICT 4 (38 barangays — Diliman/Cubao/New Manila area)
        { name: "Bagong Lipunan ng Crame", lat: 14.6112, lng: 121.0578, district: "District 4" },
        { name: "Botocan", lat: 14.6345, lng: 121.0489, district: "District 4" },
        { name: "Central", lat: 14.6089, lng: 121.0534, district: "District 4" },
        { name: "Damayang Lagi", lat: 14.6267, lng: 121.0312, district: "District 4" },
        { name: "Don Manuel", lat: 14.6167, lng: 121.0501, district: "District 4" },
        { name: "Doña Aurora", lat: 14.6145, lng: 121.0512, district: "District 4" },
        { name: "Doña Imelda", lat: 14.6123, lng: 121.0467, district: "District 4" },
        { name: "Doña Josefa", lat: 14.6156, lng: 121.0489, district: "District 4" },
        { name: "Horseshoe", lat: 14.6234, lng: 121.0445, district: "District 4" },
        { name: "Immaculate Conception", lat: 14.6067, lng: 121.0512, district: "District 4" },
        { name: "Kalusugan", lat: 14.6145, lng: 121.0334, district: "District 4" },
        { name: "Kamuning", lat: 14.6312, lng: 121.0388, district: "District 4" },
        { name: "Kaunlaran", lat: 14.6245, lng: 121.0545, district: "District 4" },
        { name: "Kristong Hari", lat: 14.6089, lng: 121.0412, district: "District 4" },
        { name: "Krus na Ligas", lat: 14.6543, lng: 121.0721, district: "District 4" },
        { name: "Laging Handa", lat: 14.6178, lng: 121.0445, district: "District 4" },
        { name: "Malaya", lat: 14.6356, lng: 121.0534, district: "District 4" },
        { name: "Mariana", lat: 14.6089, lng: 121.0378, district: "District 4" },
        { name: "Obrero", lat: 14.6245, lng: 121.0456, district: "District 4" },
        { name: "Old Capitol Site", lat: 14.6523, lng: 121.0712, district: "District 4" },
        { name: "Paligsahan", lat: 14.6145, lng: 121.0401, district: "District 4" },
        { name: "Pinagkaisahan", lat: 14.6312, lng: 121.0467, district: "District 4" },
        { name: "Pinyahan", lat: 14.6289, lng: 121.0423, district: "District 4" },
        { name: "Roxas", lat: 14.6201, lng: 121.0412, district: "District 4" },
        { name: "Sacred Heart", lat: 14.6123, lng: 121.0489, district: "District 4" },
        { name: "San Isidro Galas", lat: 14.6145, lng: 121.0523, district: "District 4" },
        { name: "San Martin de Porres", lat: 14.6178, lng: 121.0289, district: "District 4" },
        { name: "San Vicente", lat: 14.6545, lng: 121.0678, district: "District 4" },
        { name: "Santol", lat: 14.6178, lng: 121.0534, district: "District 4" },
        { name: "Santo Niño", lat: 14.6145, lng: 121.0545, district: "District 4" },
        { name: "Sikatuna Village", lat: 14.6489, lng: 121.0634, district: "District 4" },
        { name: "South Triangle", lat: 14.6189, lng: 121.0378, district: "District 4" },
        { name: "Tatalon", lat: 14.6423, lng: 121.0189, district: "District 4" },
        { name: "Teachers Village East", lat: 14.6256, lng: 121.0512, district: "District 4" },
        { name: "Teachers Village West", lat: 14.6223, lng: 121.0489, district: "District 4" },
        ...
        { name: "Valencia", lat: 14.6267, lng: 121.0134, district: "District 4" },
        // DISTRICT 5 (15 barangays — Novaliches/Fairview area)
        { name: "Bagbag", lat: 14.7289, lng: 121.0389, district: "District 5" },
        { name: "Capri", lat: 14.7156, lng: 121.0434, district: "District 5" },
        ...
        { name: "Gulod", lat: 14.7178, lng: 121.0423, district: "District 5" },
        { name: "Kaligayahan", lat: 14.7167, lng: 121.0378, district: "District 5" },
        { name: "Nagkaisang Nayon", lat: 14.7023, lng: 121.0734, district: "District 5" },
        { name: "North Fairview", lat: 14.7345, lng: 121.0623, district: "District 5" },
        { name: "Novaliches Proper", lat: 14.7267, lng: 121.0512, district: "District 5" },
        { name: "Pasong Putik Proper", lat: 14.7134, lng: 121.0512, district: "District 5" },
        { name: "Regalado", lat: 14.7167, lng: 121.0523, district: "District 5" },
        { name: "San Agustin", lat: 14.7212, lng: 121.0489, district: "District 5" },
        { name: "San Bartolome", lat: 14.7256, lng: 121.0456, district: "District 5" },
        { name: "Santa Lucia", lat: 14.7123, lng: 121.0445, district: "District 5" },
        { name: "Santa Monica", lat: 14.7089, lng: 121.0467, district: "District 5" },
        // DISTRICT 6 (11 barangays — Banlat/Balintawak/Tandang Sora area)
        { name: "Apolonio Samson", lat: 14.6523, lng: 121.0178, district: "District 6" },
        { name: "Baesa", lat: 14.6734, lng: 121.0156, district: "District 6" },
        { name: "Balon Bato", lat: 14.6956, lng: 121.0089, district: "District 6" },
        { name: "Culiat", lat: 14.6867, lng: 121.0434, district: "District 6" },
        { name: "New Era", lat: 14.6823, lng: 121.0456, district: "District 6" },
        { name: "Pasong Tamo", lat: 14.6956, lng: 121.0312, district: "District 6" },
        { name: "Sangandaan", lat: 14.6623, lng: 121.0134, district: "District 6" },
        { name: "Sauyo", lat: 14.7289, lng: 121.0612, district: "District 6" },
        { name: "Talipapa", lat: 14.7234, lng: 121.0534, district: "District 6" },
        { name: "Tandang Sora", lat: 14.6978, lng: 121.0478, district: "District 6" },
        { name: "Unang Sigaw", lat: 14.6812, lng: 121.0167, district: "District 6" }
    ];
