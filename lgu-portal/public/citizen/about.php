...
<header class="nav">
    ...
    <div class="nav-center">
        <div class="nav-links">
            ...
            <a href="about.php" class="active" data-i18n="nav_about">About</a>
        </div>
...
<div class="sidebar-nav" id="sidebarNav">
    <div class="sidebar-top">
        ...
        <ul class="nav-list">
            ...
            <li><a href="about.php" class="nav-link active"><i class="fas fa-info-circle"></i><span data-i18n="nav_about">About</span></a></li>
        </ul>
    </div>
</div>
...
<div class="form-wrapper">
    <div class="about-card">
        ...
        <div class="btn-wrap">
            <a href="citizenrepform.php" class="btn" data-i18n="about_cta_button">Submit a Report</a>
        </div>
    </div>
</div>
