    ...
    <header class="nav">
        ...
        <div class="nav-center">
            <div class="nav-links">
                ...
                <a href="<?= cimm_url_attr('citizen_feedback.php') ?>" class="active" data-i18n="nav_feedback">Feedback</a>
    ...
    <div class="sidebar-nav" id="sidebarNav">
        <div class="sidebar-top">
            ...
            <ul class="nav-list">
                ...
                <li><a href="<?= cimm_url_attr('citizenrepform.php') ?>" class="nav-link"><span><i class="fas fa-clipboard-list"></i></span><span data-i18n="nav_requests">Requests</span></a></li>
