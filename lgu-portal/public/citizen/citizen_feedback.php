...
<?php showNotification(); ?>
    ...
    <header class="nav">
        ...
        <div class="nav-center">
            <div class="nav-links">
                ...
                <a href="<?= $BASE_URL ?>citizen/citizen_feedback.php" class="active" data-i18n="nav_feedback">Feedback</a>
    ...
    <div class="sidebar-nav" id="sidebarNav">
        <div class="sidebar-top">
            ...
            <ul class="nav-list">
                <?php if ($show_login): ?>
                <li><a href="<?= $BASE_URL ?>citizen/login.php" class="nav-link"><span><i class="fas fa-lock"></i></span><span data-i18n="nav_login">Log in</span></a></li>
                <?php endif; ?>
                <li><a href="<?= $BASE_URL ?>citizen/citizencimm.php" class="nav-link"><span><i class="fas fa-home"></i></span><span data-i18n="nav_home">Home</span></a></li>
                <li><a href="<?= $BASE_URL ?>citizen/citizenreports.php" class="nav-link"><span><i class="fas fa-file-alt"></i></span><span data-i18n="nav_reports">Reports</span></a></li>
                ...
                <li><a href="<?= $BASE_URL ?>citizen/citizenrepform.php" class="nav-link"><span><i class="fas fa-clipboard-list"></i></span><span data-i18n="nav_requests">Requests</span></a></li>
                <li><a href="#" class="nav-link active"><i class="fas fa-comment-dots"></i><span data-i18n="nav_feedback">Feedback</span></a></li>
                <li><a href="<?= $BASE_URL ?>citizen/about.php" class="nav-link"><span><i class="fas fa-info-circle"></i></span><span data-i18n="nav_about">About</span></a></li>
            </ul>
        </div>
    </div>
...
<div class="feedback-page">
    ...
    <div class="fbk-card">
        ...
        <form action="<?= $BASE_URL ?>functionality/handle_feedback.php" method="POST" enctype="multipart/form-data" id="feedbackForm">
...
(function(){
    ...
    window.openRefReportModal = function(repId) {
        ...
        // Location
        document.getElementById('refModalLocation').innerHTML = (rec.location ? rec.location.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;') : '—') + makeDistrictBadge(rec.district || '');
