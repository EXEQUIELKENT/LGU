...
<div class="main-content">
    ...
    <section class="hero-section">
        ...
        <div class="hero-cta">
            <a href="<?= $BASE_URL ?>citizen/citizenrepform.php" class="cta-button cta-primary" data-i18n="cta_submit_report">Submit a Report</a>
    ...
    <section class="features-section animate-on-scroll" id="features">
        ...
        <div class="features-grid">
            <div class="feature-card animate-on-scroll delay-1">
                ...
                <a href="<?= $BASE_URL ?>citizen/citizenrepform.php" class="feature-link" data-i18n="feat1_link">Submit Request →</a>
            </div>
            <div class="feature-card animate-on-scroll delay-2">
                ...
                <a href="<?= $BASE_URL ?>citizen/citizenreports.php" class="feature-link" data-i18n="feat2_link">View Reports →</a>
            </div>
            <div class="feature-card animate-on-scroll delay-3">
                ...
                <a href="<?= $BASE_URL ?>citizen/citizenrepform.php" class="feature-link" data-i18n="feat3_link">Try It Now →</a>
            </div>
            <div class="feature-card animate-on-scroll delay-1">
                ...
                <a href="<?= $BASE_URL ?>citizen/citizenreports.php" class="feature-link" data-i18n="feat4_link">Check Status →</a>
            </div>
            <div class="feature-card animate-on-scroll delay-2">
                ...
                <a href="<?= $BASE_URL ?>citizen/about.php" class="feature-link" data-i18n="feat5_link">Learn More →</a>
            </div>
        </div>
    </section>
        ...
        <div class="activity-card">
            ...
            <?php if (!empty($recent_maintenance)): ?>
                ...
                <div style="text-align:center;margin-top:30px;">
                    <a href="<?= $BASE_URL ?>citizen/citizenreports.php" class="cta-button cta-primary" data-i18n="activity_view_all">View All Reports</a>
                </div>
            <?php else: ?>
            ...
            <div class="about-content">
                ...
                <div class="about-text">
                    ...
                    <div style="margin-top:50px;text-align:center;">
                        <a href="<?= $BASE_URL ?>citizen/about.php" class="cta-button cta-primary" data-i18n="about_learn_more">Learn More About Us</a>
                    </div>
                </div>
            </div>
        </div>
