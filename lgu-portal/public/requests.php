        ...
        <div class="gis-toolbar-card">
            ...
            <div class="gis-filter-row">
                ...
                <div class="gis-filter-row-line">
                    ...
                    <button class="gis-filter-btn infra-btn active" id="infraAll"              onclick="setInfraFilter('all')"><i class="fas fa-boxes"></i> All Types</button>
                    ...
                    <button class="gis-filter-btn infra-btn"        id="infraOthers"           onclick="setInfraFilter('others')"><i class="fas fa-file-alt"></i> Others</button>
                </div>
            </div>
        </div>
...
=======
            ...
            <div class="detail-field"><div class="detail-field-label"><i class="fas fa-map-marked-alt"></i> Coordinates</div><div class="detail-field-value" id="detailCoordinates"></div></div>
...
=======
            ...
            <div class="gis-field"><div class="gis-field-label"><i class="fas fa-map-marked-alt"></i> Coordinates</div><div class="gis-field-value" id="modalCoordinates"></div></div>
