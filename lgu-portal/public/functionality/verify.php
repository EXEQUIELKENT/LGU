...
<header class="nav">
    ...
    <div class="nav-center">
        <div class="nav-links">
            <a href="<?= $BASE_URL ?>citizen/citizencimm.php">Home</a>
            <a href="<?= htmlspecialchars($loginUrl) ?>" class="active">Log in</a>
            <a href="<?= $BASE_URL ?>citizen/citizenreports.php">Reports</a>
            <a href="<?= $BASE_URL ?>citizen/citizenrepform.php">Requests</a>
            <a href="<?= $BASE_URL ?>citizen/about.php">About</a>
        </div>
...
<div class="verify-wrapper">
    <div class="verify-card">
        ...
        <?php elseif ($state === 'expired'): ?>
            ...
            <p class="help-text">Need help? <a href="<?= htmlspecialchars($BASE_URL) ?>citizen/about.php">Contact Support</a></p>
