...
<body>
    ...
    <div class="main-content">
        ...
        <div class="quick-actions">
            <a href="road_reporting_overview.php" class="action-card">
                <div class="action-icon"><i class="fas fa-road"></i></div>
                <div class="action-title">Road Reporting</div>
                <div class="action-description">Submit and manage road damage reports</div>
            </a>
            
            <a href="inspection_management.php" class="action-card">
                <div class="action-icon"><i class="fas fa-clipboard-check"></i></div>
                <div class="action-title">Inspection Management</div>
                <div class="action-description">Schedule and conduct infrastructure inspections</div>
            </a>
        </div>
    </div>
</body>
