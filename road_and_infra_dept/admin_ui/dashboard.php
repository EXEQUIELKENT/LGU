...
<body>
    ...
    <div class="quicklinks-container">
        <?php if ($showAdminPanel): ?>
            <!-- Admin Quick Links -->
            <a href="user_and_access_management_module/admin/" class="quicklink-card">
        ...
        <?php elseif ($showOfficerPanel): ?>
            ...
            <a href="damage_assesment_and_cost_estiation_module/damage_and_cost_dashboard.php#cost" class="quicklink-card assessment">
                <div class="quicklink-icon">💰</div>
        ...
        <?php elseif ($showCitizenPanel): ?>
            <!-- Citizen Quick Links -->
            <a href="road_damage_reporting_module/road_damage.html" class="quicklink-card damage">
                <div class="quicklink-icon">🚧</div>
