...
$recentActivity = [
    ['type' => 'work_order', 'description' => 'New work order assigned', 'time' => '2 hours ago'],
    ['type' => 'assessment', 'description' => 'Damage assessment completed', 'time' => '4 hours ago'],
    ['type' => 'inspection', 'description' => 'Site inspection scheduled', 'time' => '6 hours ago']
];
?>
...
<head>
    ...
    <title>Engineer Dashboard - LGU System</title>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="../gis_mapping_and_visualization_module/" class="nav-link">🗺️ GIS Mapping</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="../document_and_report_management_module/" class="nav-link">📁 Documents</a>
                </li>
        ...
        <main class="main-content">
            ...
            <div class="header">
                <div>
                    ...
                    <p style="margin: 5px 0 0; color: #666;">Technical Assessment & Work Management</p>
                </div>
                <div class="user-info">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-label">Assigned Work Orders</div>
                </div>
                <div class="stat-card">
                ...
                <div class="card">
                    ...
                    <div class="quick-actions">
                        <a href="../damage_assesment_and_cost_estiation_module/" class="quick-action">
                            <strong>📋 New Assessment</strong><br>
                            <small>Create damage assessment</small>
                        </a>
                        ...
                        <a href="../gis_mapping_and_visualization_module/" class="quick-action">
                            <strong>🗺️ GIS Mapping</strong><br>
                            <small>Update map data</small>
                        </a>
                        <a href="../document_and_report_management_module/" class="quick-action">
                            <strong>📁 Upload Documents</strong><br>
                            <small>Add reports/photos</small>
                        </a>
                    </div>
                </div>
            </div>
