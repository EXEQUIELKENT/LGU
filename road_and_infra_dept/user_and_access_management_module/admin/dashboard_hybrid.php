...
<body>
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                <li class="nav-item">
                    <a href="dashboard_hybrid.php" class="nav-link active">📊 Dashboard</a>
                </li>
                <li class="nav-item">
                    <a href="approval.php" class="nav-link">👥 User Approval</a>
                </li>
                <li class="nav-item">
            ...
            <div class="content-grid">
                ...
                <div class="card">
                    ...
                    <div class="activity-item">
                        <div class="activity-type">✅ PHP Dashboard Working</div>
                        <div class="activity-time">Just now</div>
                    </div>
                    <div class="activity-item">
                        <div class="activity-type">👤 User logged in</div>
                        <div class="activity-time"><?php echo date('H:i ago'); ?></div>
                    </div>
                    <div class="activity-item">
                        <div class="activity-type">🔧 System initialized</div>
                ...
                <div class="card">
                    ...
                    <div class="quick-actions">
                        <a href="approval.php" class="quick-action">
